var __webpack_modules__ = ({
  "./src/regular named export dynamic esm/moduleA.js":
    ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const namedWithImportedValue = async () => {
        const moduleC = await __webpack_require__.e("dynamicImportChunk").then(__webpack_require__.bind(__webpack_require__, "./src/regular named export dynamic esm/moduleC.js"));
